...
const Import = () => {
  ...
  <section class="product-section">
    ...
    <div class="product-grid">
      ...
      <div class="product-card">
        <img src="/public/grand_cherokee.jpg" alt="Jeep Grand Cherokee" />
      ...
      <div class="product-card">
        <img src="/public/range_rover.jpg"alt="Range Rover" />
        <h3>Range Rover</h3>
      ...
      <div class="product-card">
        <img src="/public/corolla.jpeg" alt="Jeep Compass" />
        <h3>Corolla</h3>
